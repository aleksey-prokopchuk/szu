...
const prodEll = `
          <div class="card-product__wrapper">
            <div class="card-product__wrapper-img">
              <img class="card-product__img" src="${codes[1].url_big}" alt="${codes[1].title}" />
            </div>
            <div class="card-product__wrapper-description">
              ...
              <ul class="card-product__list list-no-marker">
                <li class="card-product__item">
                  <p class="card-product__description">${codes[1].date}</p>
                </li>
                <li class="card-product__item">
                ...
                <li class="card-product__item">
                  <p class="card-product__description">Кількість сторінок: ${codes[1].pages_q}</p>
                </li>
                <li class="card-product__item">
